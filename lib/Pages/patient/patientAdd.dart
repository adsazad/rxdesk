              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildTextField(
                        "Mobile", Icons.phone, (val) => _mobile = val),
                    const SizedBox(height: 12),
                    _buildTextField(
                        "Age", Icons.calendar_today, (val) => _age = val),
                    const SizedBox(height: 12),
                    _buildTextField(
                        "Height (cm)", Icons.height, (val) => _height = val),
                    const SizedBox(height: 12),
                    _buildTextField(
                        "Weight (kg)", Icons.monitor_weight, (val) =>
                    _weight = val),
                      ...
                      child: ElevatedButton.icon(
                        ...
                        onPressed: () async {
                          if (_formKey.currentState!.validate()) {
                            ...
                            final String? existing = prefs.getString(
                                'patients');
                            ...
                            await prefs.setString(
                                'patients', jsonEncode(patientsList));
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
